...
from decouple import config  # ДОБАВЛЕНО
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME'), # ДОБАВЛЕНО
        'USER': config('DB_USER'), # ДОБАВЛЕНО
        'PASSWORD': config('DB_PASSWORD'), # ДОБАВЛЕНО
        'HOST': config('DB_HOST'), # ДОБАВЛЕНО
        'PORT': config('DB_PORT'), # ДОБАВЛЕНО
    }
}
...
LANGUAGE_CODE = 'ru-RU'  # ДОБАВЛЕНО

TIME_ZONE = 'Europe/Moscow'  # ДОБАВЛЕНО
...
CORS_ALLOW_ALL_ORIGINS = True  # В продакшене укажи конкретные домены
